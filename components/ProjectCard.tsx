      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mt-16 mb:6 lg:flex-row lg:items-start w-full lg:mt-32 lg:mb-12">
          <div className="flex flex-col w-full border-y-[3px] border-light-grey text-left text-b-l_black lg:w-1/3 py-16 lg:mr-32 lg:text-b-xl_black">
            <p>Bookmark</p>
            <p className="mt-10 text-n-m_grey tracking-wide leading-relaxed 2xl:text-n-l_grey 2xl:leading-relaxed">
            ...
            <button className="mt-10 w-60 text-b-s_grey text-center uppercase border-2 px-8 py-4 hover:bg-black hover:text-b-s_white hover:border-black">
          ...
          <div className="flex flex-col my-16 lg:my-0 lg:w-2/3 text-left">
            <div className="flex flex-col">
              <p className='text-b-m_grey tracking-wide lg:text-b-l_grey'>Project Background</p>
              <p className="my-10 text-n-m_grey tracking-wide leading-relaxed 2xl:text-n-l_grey 2xl:leading-relaxed">
                {projects[currentIndex].description}
              </p>
            </div>
            <div className="flex flex-col">
              <p className='my-10 text-b-m_grey tracking-wide lg:text-b-l_grey'>Static Preview</p>
          ...
          <button className="flex w-1/2 justify-start" onClick={handleOnPrevClick}>
            <div className="flex flex-row py-8">
              ...
              <div className="flex flex-col text-left pl-6">
                <p className="text-sb-m_grey lg:text-sb-l_grey">{projects[prevProjIndex].name}</p>
                <p className="text-sb-s_grey">Previous Project</p>
              </div>
            </div>
          </button>
          <button className="flex w-1/2 justify-end" onClick={handleOnNextClick}>
            <div className="flex flex-row py-8">
              <div className="flex flex-col text-right pr-6">
                <p className="text-sb-m_grey lg:text-sb-l_grey">{projects[nextProjIndex].name}</p>
                <p className="text-sb-s_grey">Next Project</p>
              </div>
              <div className="flex items-center">
